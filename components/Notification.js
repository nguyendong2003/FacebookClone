...
export default function Notification({ navigation, item, onDelete }) {
      ...
      case "friend_request":
        return (
          <Image
            ...
            source={require("../iconfb/friend.png")}
          />
        );
        break;
      default:
  ...
  const { acceptFriendRequest, getFriendRequests, rejectFriendRequest } =
